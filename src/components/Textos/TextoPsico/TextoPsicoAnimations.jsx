...
const useTextoPsicoAnimations = () => {
  useEffect(() => {
    ...
    mm.add("(min-width: 768px)", () => {
      // Animação para o container-textopsico-2
      gsap.fromTo(
        ".container-textopsico-2",
        {
        ...
        },
        {
          ...
          scrollTrigger: {
            trigger: ".container-textopsico-2",
...
export default useTextoPsicoAnimations;